...
enum EnTabNumber
{
	NB_TAB_CPU, NB_TAB_MB, NB_TAB_RAM, NB_TAB_SYS, NB_TAB_GPU, NB_TAB_ABOUT
};
...
enum EnObjects
{
	...
	FRAMBANKS, FRAMOS, FRAMMEMORY, FRAMGPU1, FRAMGPU2, FRAMGPU3, FRAMGPU4, FRAMABOUT, FRAMLICENSE,
...
enum EnTabGraphics
{
	...
	GPUVENDOR3, GPUNAME3, GPUDRIVER3,
	GPUVENDOR4, GPUNAME4, GPUDRIVER4,
	LASTGPU
};
