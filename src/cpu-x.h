...
enum EnObjects
{
	TABCPU, TABMB, TABSYS, TABABOUT,
	FRAMPROCESSOR, FRAMCLOCKS, FRAMCACHE, FRAMMOBO, FRAMBIOS, FRAMOS, FRAMMEMORY, FRAMABOUT, FRAMLICENSE,
	LABVERSION, LABDESCRIPTION, LABAUTHOR, LABLICENSE,
	LASTOBJ
};
