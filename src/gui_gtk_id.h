...
{
	"card0_vend", "card0_driver", "card0_umd", "card0_mod", "card0_did_rid", "card0_pcie", "card0_temp", "card0_usage", "card0_vram_used", "card0_gclk", "card0_mclk", "card0_gvolt", "card0_gpwr"
};
